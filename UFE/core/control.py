...
import _split_frcsts_by_model as split
...
def main(freq):
    ...
    # split and save forecasts model by model
        modelsdict = split.split(all_forecasts)
        split.prep_fcst_by_model_for_save(modelsdict)
